...
> **Updated 2026-05-19.** v2.5.0 → v2.5.4 ALL SHIPPED on 2026-05-19 (8 phases of v2.5 end-to-end in a single dev day + 3 live-audit patches + 1 hardening release): v2.5.1 chat-pipe alias, v2.5.2 cycle-detect orphan-tool_use, v2.5.3 rollback-hint preservation, v2.5.4 hardening (C-1 part B Origin allowlist, M-1 traceback redaction, N-1 first-run hint, H-1 regression tests, cross-runtime schema parity, mock-eval scenario scaffolding). Tool count 105 → 109; tests 2000 → 2141+. **Two-stage audit response:** PR [#53](https://github.com/dreamrec/TDPilot_deepseekv4/pull/53) (squash `6a9aabe`) closed C-1 part A + H-1..H-4 + M-2 + parity test; PR [#55](https://github.com/dreamrec/TDPilot_deepseekv4/pull/55) (squash `ea1e8df`, the v2.5.4 tag) closed the deferred items + adds the version-cascade guard CI gate. See [`plans/README.md` post-2.5.3 retrospective](./plans/README.md#post-253-audit-retrospective-2026-05-19) and [`plans/AUDIT_2026_05_19_FOLLOWUPS.md`](./plans/AUDIT_2026_05_19_FOLLOWUPS.md) for the full landed breakdown. v2.4.0 SHIPPED 2026-05-13. The v2.5–v2.7 arc supersedes the original v2.2→v3.0 plan below.
...
|---|---|---|---|
| v2.5 | Agent self-awareness + safety + distribution polish (+ live-audit + hardening patches) | [`plans/v2.5_IMPLEMENTATION_PLAN.md`](./plans/v2.5_IMPLEMENTATION_PLAN.md) | **SHIPPED 2026-05-19** ([v2.5.0](https://github.com/dreamrec/TDPilot_deepseekv4/releases/tag/v2.5.0) · [v2.5.1](https://github.com/dreamrec/TDPilot_deepseekv4/releases/tag/v2.5.1) · [v2.5.2](https://github.com/dreamrec/TDPilot_deepseekv4/releases/tag/v2.5.2) · [v2.5.3](https://github.com/dreamrec/TDPilot_deepseekv4/releases/tag/v2.5.3) · [v2.5.4](https://github.com/dreamrec/TDPilot_deepseekv4/releases/tag/v2.5.4)) |
